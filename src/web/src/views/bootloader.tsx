...
export const BootloaderView = ({ loader, uki, removable }: Props) => {
  const formAttrs: Record<string, string> = {
    'data-signals': JSON.stringify({ loader, uki, removable }),
  }
  return (
    <Layout active="bootloader">
      <Page heading="Bootloader" subhead="UEFI boot manager.">
