...
SP_API sp_ps_t         sp_ps_create_cstr(sp_mem_t mem, sp_ps_config_cstr_t config);
SP_API sp_ps_output_t  sp_ps_run_cstr(sp_mem_t mem, sp_ps_config_cstr_t config);
...
sp_ps_t sp_ps_create_cstr(sp_mem_t mem, sp_ps_config_cstr_t config) {
  return sp_ps_create(mem, sp_ps_config_view_from_cstr(&config));
}

sp_ps_output_t sp_ps_run_cstr(sp_mem_t mem, sp_ps_config_cstr_t config) {
